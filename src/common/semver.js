/**
 * https://github.com/BetterDiscord/BetterDiscord/blob/07a97e24344b6506a90efb343519d7f49170cf06/renderer/src/structs/semver.js
 */
...
export function comparator(currentVersion, remoteVersion) {
    ...
    const versionCompare =
        compare(remote[1], current[1]) ||
        compare(remote[2], current[2]) ||
        compare(remote[3], current[3]);
